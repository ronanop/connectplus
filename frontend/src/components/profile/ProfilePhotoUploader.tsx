  ...
  return (
    <div className="rounded-2xl border border-[var(--border)]/80 bg-[var(--bg-surface)]/95 p-6 shadow-sm">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
        <div className="flex h-24 w-24 flex-shrink-0 items-center justify-center overflow-hidden rounded-full bg-gradient-to-br from-[var(--accent-primary)]/20 to-[var(--accent-gold)]/20 text-[var(--accent-primary)]">
          {profilePhotoUrl ? (
            <img
              src={profilePhotoUrl}
              alt=""
        ...
        <div className="flex flex-1 flex-col gap-3">
          <div className="flex flex-wrap gap-3">
            ...
            <button
              type="button"
              disabled={uploading}
              className="inline-flex min-h-[48px] items-center gap-2 rounded-xl border border-[var(--border)] bg-[var(--bg-elevated)] px-4 text-sm font-medium text-[var(--text-primary)] disabled:opacity-50"
