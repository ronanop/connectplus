    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-neutral-500">
          Check in and check out with location and face verification.
        </p>
      </div>
        ...
        <div className="rounded-2xl border border-[var(--border)]/80 bg-[var(--bg-surface)]/95 p-6 shadow-sm">
          ...
          {!hasFace ? (
            <div className="space-y-4">
              ...
              <Link
                to="/profile"
                className="inline-flex min-h-[48px] items-center rounded-xl bg-[var(--accent-primary)] px-4 py-2 text-sm font-medium text-white"
              >
                Set up Face ID →
              </Link>
              <button
            ...
            <div className="space-y-4">
              ...
              {!today.checkOutAt ? (
                <button
                  ...
                  className="inline-flex min-h-[48px] items-center gap-2 rounded-xl border border-[var(--border)] px-4 py-2 text-sm font-medium"
                >
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                className="w-full min-h-[48px] rounded-xl bg-[var(--accent-primary)] px-4 py-3 text-sm font-semibold text-white"
              >
                Mark Attendance
              </button>
            </div>
        ...
        <div className="rounded-2xl border border-[var(--border)]/80 bg-[var(--bg-surface)]/95 p-6 shadow-sm">
          <div className="mb-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="min-w-[8rem] text-center text-sm font-medium">{format(calMonth, "MMMM yyyy")}</span>
              <button
                type="button"
