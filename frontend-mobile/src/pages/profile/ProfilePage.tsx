    ...
    <div className="w-full min-w-0 space-y-6 overflow-x-hidden pb-8">
      ...
      <div className="grid w-full grid-cols-1 gap-6">
        <div className="min-w-0 max-w-full rounded-2xl border border-[var(--border)]/80 bg-[var(--bg-surface)]/95 p-4 shadow-sm sm:p-6">
          ...
          <div className="space-y-4">
            <div className="flex min-w-0 items-start gap-4">
              <div className="flex h-16 w-16 shrink-0 items-center justify-center overflow-hidden rounded-full bg-gradient-to-br from-[var(--accent-primary)]/20 to-[var(--accent-gold)]/20 text-[var(--accent-primary)]">
                {profilePhotoUrl ? (
              ...
              <div className="min-w-0 flex-1">
                <p className="break-words text-lg font-semibold text-[var(--text-primary)]">{name}</p>
                <p className="text-sm text-neutral-500 [overflow-wrap:anywhere]">
                  {String(displayUser.email ?? "No email")}
                </p>
              </div>
            </div>

            <div className="min-w-0 space-y-3 border-t border-[var(--border)]/50 pt-4">
        ...
        <div className="min-w-0 max-w-full rounded-2xl border border-[var(--border)]/80 bg-[var(--bg-surface)]/95 p-4 shadow-sm sm:p-6">
          ...
          <div className="space-y-4">
            <div className="min-w-0 rounded-lg bg-[var(--bg-elevated)]/60 p-4">
              <p className="text-xs font-medium uppercase tracking-[0.1em] text-neutral-400">Email Address</p>
              <p className="mt-2 text-sm text-[var(--text-primary)] [overflow-wrap:anywhere]">
            ...
            <div className="min-w-0 rounded-lg bg-[var(--bg-elevated)]/60 p-4">
              ...
              <p className="mt-2 break-words text-sm text-[var(--text-primary)]">Active</p>
            </div>
