...
/** Browsers only expose Geolocation on secure origins (HTTPS) except localhost. */
...
/**
 * Tries GPS first; on timeout/unavailable falls back to network/cached position (better indoors / some Android devices).
 */
